...
class UrdfChunkAssembler:
    ...
    def consume(
        ...
        if packet.get("type") != "pylon_vessel_urdf_chunk":
...
def _model_from_bundle(
    ...
    if bundle.get("type") != "pylon_active_vessel_proxy" or bundle.get("version") != 1:
    ...
    vessel_id = _strict_string(bundle.get("vesselId"), "vesselId")
    ...
    base_to_root_translation = _parse_number_array(
        bundle.get("baseToRootPosition"),
        "baseToRootPosition",
        3,
    )
    raw_base_to_root_rotation = _parse_number_array(
        bundle.get("baseToRootRotation"),
        "baseToRootRotation",
        4,
    )
