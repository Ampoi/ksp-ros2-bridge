...
{
    public sealed partial class KerbalRosVesselModelManager
    {
        ...
        )
        {
            foreach (var geometry in geometries)
            {
                ...
                var rosRotation = UnityRotationToRos(geometry.Rotation);
        ...
        internal static Vector3 UnityVectorToRos(Vector3 value)
        {
        ...
        internal static Quaternion UnityRotationToRos(Quaternion value)
        {
