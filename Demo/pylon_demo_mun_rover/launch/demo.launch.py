...
def generate_launch_description():
    share=get_package_share_directory('pylon_demo_mun_rover')
    ...
    for package,executable in servers:
        ...
        nodes.append(Node(package=package,executable=executable,name=executable,namespace='pylon/mun_rover',output='screen',
            parameters=[params,overrides],remappings=[('/tf','/tf'),('/tf_static','/tf_static')]))
    nodes.append(Node(package='nav2_lifecycle_manager',executable='lifecycle_manager',name='lifecycle_manager_navigation',namespace='pylon/mun_rover',
